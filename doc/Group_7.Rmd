...
![<font size="4">Fig.3-Violin plot of wing shape</font>](../results/plots/02_PC2_wing_shape.png){width=69%}
</div>
</div>
</div>
</div>
...
<div class="columns-2">
<center>
![<font size="4">PCA population</font>](../results/plots/05_PCA_population.png){width=70%}
</center>
<center>
![<font size="4">PCA distance class</font>](../results/plots/05_PCA_distance.png){width=70%}
</center>
</div>
</div>
</div>
