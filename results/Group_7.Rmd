...
node [shape = oval, style = filled, fillcolor = LightPink, fontname = Arial]

data1 [label = 'Dataset 1', shape = folder, fillcolor = PaleTurquoise]
data2 [label = 'Dataset 2', shape = folder, fillcolor = PaleTurquoise]
process [label =  'Data \n Processing']
augment [label = 'Data \n Augmentation']
visual [label = 'Data \n Visualizations']
...
<center><font size="4">Analysis of flight power</font></center>
</div>
...
![](plots/04_gene_expression.png){width=100%}
<div>

![](plots/04_heat_maps.png){width=100%}
