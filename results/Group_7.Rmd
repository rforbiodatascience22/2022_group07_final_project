...
node [shape = oval, style = filled, fillcolor = Turquoise, fontname = Arial]

data1 [label = 'Dataset 1', shape = folder, fillcolor = SeaGreen]
data2 [label = 'Dataset 2', shape = folder, fillcolor = SeaGreen]
process [label =  'Data \n Processing']
augment [label = 'Data \n Augmentation']
visual [label = 'Data \n Visualizations']
...
<div class="columns-2">
<div align="center">
![<font size="4">Fig.2-Violin plot of average velocity</font>](plots/02_averagevelocity.png){width=69%}


![<font size="4">Fig.3-Violin plot of wing shape</font>](plots/02_PC2_wing_shape.png){width=69%}
</div>
</div>
</div>
</div>
...
![](plots/04_flight_performance.png){width=100%}
...
<div class="columns-2">
<center>
![<font size="4">Fig.5-Box plots of gene expression</font>](plots/04_gene_expression.png){width=70%}
</center>
<center>
![<font size="4">Fig.6-Heat maps of gene expression</font>](plots/04_heat_maps.png){width=70%}
</center>
</div>
</div>
</div>
...
<center>
![](plots/05_gene_expression.png){width=95%}</center>
